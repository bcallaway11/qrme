...
This is code for Callaway, Li, and Murtazashvili (2021) ``Nonlinear Approaches to Intergenerational Mobility Allowing for Measurement Error.''  The code mainly contains our implementations of 
...
I only lightly support this code, and it is more like a demonstration of the type of code that can work in this case as well as a replication package for our work.
